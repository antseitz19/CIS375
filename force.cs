...
{ 
    ...
    //same functions as every other 
    
    class aiEnemyForce : cForce
    {
        private cVector3 point;
        public aiEnemyForce(cVector3 ppoint) : base()
        {
            this.point = ppoint;
            _pulldirection = new cVector3();
        }
        ...
        public override cForce copy()
        {
            aiEnemyForce f = new aiEnemyForce(point);
            f.copy(this);
            return f;
        }
        ...
        public override cVector3 force(cCritter pcritter)
        {
            ...
            cVector3 transvector = -(pcritter.Position - point); //how far and in what direction to destination point
            _pulldirection = transvector;
            return _pulldirection * _intensity * pcritter.Mass;
        }
