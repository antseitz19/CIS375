...
namespace ACFramework
{
    ...
    class cListener
    {
        public static readonly float CRITTERTURNSPEEDSLOW = 11.25f * (float)Math.PI; //Slow Radians per second to turn. Try 0.5*PI 
        public static readonly float CRITTERTURNSPEEDFAST = 11.0f * (float)Math.PI; //Fast Radians per second to turn. Try 2.0*PI 
    ...
    class cListenerViewerRide : cListener //Assume 3D 
    {
        ...
        public static readonly float PLAYERLOOKAHEAD = 18.0f;
